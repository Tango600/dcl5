/******************************************************************************/
/*                 Generated by IBExpert 07.12.2015 10:44:27                  */
/******************************************************************************/
...
CREATE DATABASE 'localhost:D:\Tango\My Projects\DCL\DemoDB\TemplateDCL.fdb'
...
CREATE TABLE DCL_USERS (
    ...
    DCL_USER_PASS       DM_PASSWORD /* DM_PASSWORD = VARCHAR(35) */,
    DCL_ROLE            INTEGER,
    SHOWINLIST          SMALLINT,
...
INSERT INTO DCL_TEMPLATES (TEID, TEMPL_NAME, TEMPL_DATA, TEMPL_DATATYPE) VALUES (1001, 'SaveBS', :h2A83_336, NULL);
INSERT INTO DCL_TEMPLATES (TEID, TEMPL_NAME, TEMPL_DATA, TEMPL_DATATYPE) VALUES (1002, 'LoadBS', :h2DB9_336, NULL);
INSERT INTO DCL_TEMPLATES (TEID, TEMPL_NAME, TEMPL_DATA, TEMPL_DATATYPE) VALUES (1003, 'ZIP', :h30EF_336, NULL);
INSERT INTO DCL_TEMPLATES (TEID, TEMPL_NAME, TEMPL_DATA, TEMPL_DATATYPE) VALUES (1004, 'UnZIP', :h3425_336, NULL);
...
DESCRIBE TABLE DCL_INI_PROFILES
'Параметры диалогов';

DESCRIBE TABLE DCL_NOTIFYCATIONS
'Сообщения';
...
DESCRIBE TABLE DCL_USER_LOGIN_HISTORY
'История подключений';

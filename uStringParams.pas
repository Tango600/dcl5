...
Begin
  If UTF8Base Then
    Result:=ConvertEncoding(S, DefaultSystemEncoding, GPT.ServerCodePage) // UTF8ToAnsi(S)
  Else
    Result:=S;
End;
...
Function SourceToInterface(S: String): String;
Begin
  Result:=ConvertEncoding(S, DefaultSourceEncoding, DefaultInterfaceEncoding); // AnsiToUTF8(S)
End;
